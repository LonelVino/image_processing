...
% truncate the TF coefficient of contour 'z' according to index 'cmax'
% Args
% -----------------------
%   z : the complex representation of the contour
%   cmax : the truncation index of TF coefficients
% Returns
% -----------------------
